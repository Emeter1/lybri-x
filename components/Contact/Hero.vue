        ...
        >
          <div class="w-full space-y-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div class="space-y-1">
                ...
                <input
                  ...
                  class="w-full px-4 py-2 rounded-xl border border-gray-200 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 outline-none transition-all placeholder:text-gray-400 font-sans"
                />
              </div>
              <div class="space-y-1">
                <label
            ...
            <div class="space-y-1">
              ...
              <textarea
                rows="2"
                class="w-full px-4 mb-2 py-2 rounded-xl border border-gray-200 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 outline-none transition-all resize-none font-sans"
              ></textarea>
            </div>
          </div>
